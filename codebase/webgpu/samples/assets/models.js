import { vec3 } from './wgpu-matrix.module.js';
import { mesh as teapot } from './meshes/teapot/teapot.js';
import { mesh as dragon } from './meshes/stanfordDragon/stanfordDragon.js';
import { createSphereMesh } from './meshes/sphere.js';
...
export function convertMeshToTypedArrays(mesh, scale, offset = [0, 0, 0]) {
...
function flattenNormals({ vertices, indices, }) {
